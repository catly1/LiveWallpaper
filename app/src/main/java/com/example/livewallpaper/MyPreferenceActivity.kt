...
class MyPreferencesActivity : PreferenceActivity() {
    ...
    internal var numberCheckListener: Preference.OnPreferenceChangeListener =
        Preference.OnPreferenceChangeListener { preference, newValue ->
            ...
            Toast.makeText(
                this@MyPreferencesActivity, resources.getString(R.string.label_invalid_input),
                Toast.LENGTH_SHORT
            ).show()
            false
        }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // accepts numbers
        val circlePreference = preferenceScreen.findPreference(resources.getString(R.string.label_number_of_circles))
